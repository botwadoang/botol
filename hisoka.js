...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${text}?apikey=b77e26178041440775e291bb`)
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/stalktiktok/${text}?apikey=b77e26178041440775e291bb`)
...
mee = await hisoka.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.lolhuman.xyz/api/editor/${command}?apikey=b77e26178041440775e291bb&img=${mem}`
memek = await hisoka.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
break
...
mee = await hisoka.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.lolhuman.xyz/api/filter/${command}?apikey=b77e26178041440775e291bb1&img=${mem}`
memek = await hisoka.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
break
...
mee = await hisoka.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.lolhuman.xyz/api/creator1/${command}?apikey=b77e26178041440775e291bb&img=${mem}`
memek = await hisoka.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
break
...
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/sticker/${command}?apikey=b77e26178041440775e291bb`)
...
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=b77e26178041440775e291bb&name=${text}`) 
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
...
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/pacarserti?apikey=b77e26178041440775e291bb&name1=${text}&name2=${text}`) 
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
        case 'couple': {
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/mediafire?apikey=b77e26178041440775e291bb&url=${text}`)
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/groupwhatsapp?apikey=b77e26178041440775e291bb&query=${text}`)
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/sholat/pekanbaru?apikey=b77e26178041440775e291bb`)
...
case 'audio1': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/1?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio2': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/2?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio3': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/3?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio4': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/4?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio5': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/5?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio6': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/6?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio7': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/7?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio8': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/8?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio9': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/9?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio10': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/10?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'anime': case 'waifu': case 'husbu': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': {
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapi.xyz/api/random/${command}?apikey=b77e26178041440775e291bb`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
...
case 'asupan': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/asupan?apikey=b77e26178041440775e291bb`)
